import pika # not have thread pool, need to close manually, cannot use singleton
import json
...
class CloudAMQPClient:
    ...
    def getMessage(self):
        ...
        if method_frame is not None:
            ...
            # acknowledge server that we already received message, server would delete message
